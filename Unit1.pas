...
begin
showmessage('Программа предназначена для конвертации'+#13+
'изображений в 16 битный формат RGB565'+#13+
'и BGR565 для дисплеев ILI9341 ST7735 и др.'+#13+#13+'Дмитрий Иванов 2023'+#13+
